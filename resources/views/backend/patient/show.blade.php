        ...
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="me-3">
                        @php
                            $avatar = $patient->user->image_path ? asset('storage/' . $patient->user->image_path) : asset('assets/images/default-avatar.png');
                        @endphp
                        <img src="{{ $avatar }}" alt="Avatar" class="rounded-circle" width="120" height="120" style="object-fit: cover; border: 3px solid #0d6efd;">
                    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="p-3 bg-light rounded">
                            <strong>Gender:</strong> <span class="badge bg-info">{{ ucfirst($patient->user->gender ?? '-') }}</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="p-3 bg-light rounded">
                            <strong>DOB:</strong> <span class="text-success">{{ $patient->dob ?? '-' }}</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="p-3 bg-light rounded">
                            <strong>Blood Group:</strong> <span class="badge bg-danger">{{ $patient->blood_group ?? '-' }}</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="p-3 bg-light rounded">
                    ...
                    <div class="col-md-6">
                        <div class="p-3 bg-light rounded">
                            <strong>Emergency Contact:</strong> <span class="text-warning">{{ $patient->emergency_contact ?? '-' }}</span>
                        </div>
                    </div>
                </div>
