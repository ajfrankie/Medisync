    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body row align-items-center">
            <div class="col-md-4 text-center mb-3">
                @if($avatar)
                    <img src="{{ $avatar }}" class="rounded-circle mb-2" width="120" height="120" style="object-fit: cover;">
                @else
        ...
        <div class="card-body row">
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="past_surgeries" class="form-control" value="{{ $patient->past_surgeries ?? '' }}">
                </div>
                <div class="mb-3">
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="preferred_language" class="form-control" value="{{ $patient->preferred_language ?? '' }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="emergency_person" class="form-control" value="{{ $patient->emergency_person ?? '' }}">
                </div>
                <div class="mb-3">
