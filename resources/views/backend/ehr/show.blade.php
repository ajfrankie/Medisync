                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <p class="form-control-plaintext">{{ \Carbon\Carbon::parse($ehr->visit_date)->format('d M Y') ?? 'N/A' }}</p>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-bold">Next Visit Date</label>
                            <p class="form-control-plaintext">{{ $ehr->next_visit_date ? \Carbon\Carbon::parse($ehr->next_visit_date)->format('d M Y') : 'N/A' }}</p>
                        </div>
                    </div>
